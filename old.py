...
START_GAP_WIDTH = 8
MIN_GAP_WIDTH = 3
SPAWN_EVERY_SEC = 0.90 * FALL_START_SEC
SPEEDUP_EVERY = 8
SPEEDUP_FACTOR = 0.92
TICK = 1/60
...
def run(stdscr):
    ...
    while True:
        ...
        hud = f" Terminal Dropper | Score: {g['survived']}  Gap:{g['gap_width']}  Spawn:{g['spawn_dt']:.2f}s  Fall:{g['fall_dt']:.2f}s  [←/→ or A/D]  (P)ause  (R)estart  (Q)uit "
